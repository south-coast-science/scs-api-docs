/*! For license information please see swagger-ui-standalone-preset.js.LICENSE.txt */ ! function webpackUniversalModuleDefinition(t, e) {
			...
			9404: function(t) {
				t.exports = function() {
					...
					function setListBounds(t, e, r) {
						...
						if (c < o && (y = y && y.removeAfter(n, 0, c)), s >= d) s -= d, c -= d, f = a, l = null, y = y && y.removeBefore(n, 0, s);
						else if (s > i || d < p) {
							for (h = 0; l;) {
								var b = s >>> f & u;
								if (b !== d >>> f & u) break;
	...
	return (() => {
		...
		const logo_small = t => n.createElement("svg", _extends({
			...
			components_Logo = () => n.createElement(logo_small, {
				height: "40"
			}),
			top_bar = () => ({              // removed topbar components
